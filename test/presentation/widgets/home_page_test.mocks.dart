...
// in dojo_challenge_app/test/presentation/widgets/home_page_test.dart.
...
import 'package:dojo_challenge_app/core/auth/auth_state.dart' as _i10;
import 'package:dojo_challenge_app/core/parameter/data_source.dart' as _i8;
import 'package:dojo_challenge_app/core/parameter/endpoint.dart' as _i7;
...
class MockMoviesBloc extends _i1.Mock implements _i4.MoviesBloc {
  ...
  @override
  _i5.Future<void> getMovies({
    required _i7.Endpoint? endpoint,
    _i8.DataSource? dataSource,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMovies,
...
class MockDatabaseDataSource extends _i1.Mock
  ...
  @override
  _i5.Future<List<_i6.Movie>> getMovies({
    required _i7.Endpoint? endpoint,
    int? movieId,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> insertRecommendedMovie({
    required int? baseMovieId,
    required _i6.Movie? recommendedMovie,
    required int? order,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<void> deleteMoviesByType(String? movieType) => (super.noSuchMethod(
        Invocation.method(
          #deleteMoviesByType,
          [movieType],
        ),
  ...
  @override
  _i5.Future<void> deleteRecommendationsByMovieType(String? movieType) =>
      (super.noSuchMethod(
        Invocation.method(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthState extends _i1.Mock implements _i10.AuthState {
  MockAuthState() {
    _i1.throwOnMissingStub(this);
  }
